//CLASSWORK
//using js es6 class and modules, create a separate modules (person.js, student.js,), and create ur primary javaascript file (main.js). the person property should be just 'name' and 'age'. student class shoukld extend person. the property of a student is name, age and grade
